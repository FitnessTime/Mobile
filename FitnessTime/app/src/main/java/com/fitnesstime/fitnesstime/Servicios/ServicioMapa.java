...
public class ServicioMapa extends Service {
    ...
    private class LocationListener implements android.location.LocationListener {
        ...
        public void onLocationChanged(Location location) {
            ...
            FitnessTimeApplication.getEventBus().post(new EventoCambioPosicionGPS(location));
        }

        @Override
        public void onProviderDisabled(String provider) {
            HelperToast.generarToast(getApplicationContext(), "GPS desactivado, por favor enciendalo");
        }
